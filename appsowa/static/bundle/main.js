...
/* harmony import */ var _sass_style_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
/* harmony import */ var _js_header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
...
/* harmony import */ var _components_datepicker_datepicker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
/* harmony import */ var _components_datepicker_datepicker__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_datepicker_datepicker__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_datepicker_subdatepicker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16);
/* harmony import */ var _components_datepicker_subdatepicker__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_datepicker_subdatepicker__WEBPACK_IMPORTED_MODULE_3__);
//scss
 //js
...
(function () {
  ...
  reactHotLoader.register(btnInfo, "btnInfo", "D:\\app-sowa\\appSowa\\appsowa\\static\\js\\header.js");
  reactHotLoader.register(info, "info", "D:\\app-sowa\\appSowa\\appsowa\\static\\js\\header.js");
  leaveModule(module);
})();
...
function () {
  ...
  function DatePicker() {
    var currentDate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DatePicker.getDefaultDate();
    ...
    this.initSelector = '.datepicker'; //нижнее подчеркивание указывает на то что сво-во личное

    this._show = false; //объевляем статическое свойство
  ...
  _createClass(DatePicker, [{
    ...
    value: function showDatepicker() {
      this.show = true;
      console.log("\u0421\u0435\u0433\u043E\u0434\u043D\u0435\u0448\u043D\u0435\u0435 \u0447\u0438\u0441\u043B\u043E ".concat(this.currentDate));
    } //статический метод
...
function (_DatePicker) {
  _inherits(SubDatePicker, _DatePicker);

  //если у подкласса нет constructor он использует родительский
  function SubDatePicker(currentDate, title, foo) {
    var _this;

    _classCallCheck(this, SubDatePicker);

    //если указываем конструктор то нужно вызвать родительский конструктор с помощью super()
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SubDatePicker).call(this, currentDate, title));
    _this.foo = foo;
    return _this;
  } //перезаписываем метод родителя


  _createClass(SubDatePicker, [{
    key: "showDatepicker",
    value: function showDatepicker() {
      this.show = true;
      var date = new Date(98, 1);
      console.log("\u0421\u0435\u0433\u043E\u0434\u043D\u0435\u0448\u043D\u0435\u0435 \u0447\u0438\u0441\u043B\u043E ".concat(date));
    }
  }, {
    key: "__reactstandin__regenerateByEval",
    // @ts-ignore
  ...
  return SubDatePicker;
}(DatePicker);

var datepicker = new DatePicker(new Date(), '123');
var subdatepicker = new SubDatePicker(new Date(), '321', '123123');
...
(function () {
  ...
  reactHotLoader.register(DatePicker, "DatePicker", "D:\\app-sowa\\appSowa\\appsowa\\static\\components\\datepicker\\datepicker.js");
  reactHotLoader.register(SubDatePicker, "SubDatePicker", "D:\\app-sowa\\appSowa\\appsowa\\static\\components\\datepicker\\datepicker.js");
  reactHotLoader.register(datepicker, "datepicker", "D:\\app-sowa\\appSowa\\appsowa\\static\\components\\datepicker\\datepicker.js");
  reactHotLoader.register(subdatepicker, "subdatepicker", "D:\\app-sowa\\appSowa\\appsowa\\static\\components\\datepicker\\datepicker.js");
  leaveModule(module);
})();
