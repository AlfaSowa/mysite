                ...
                <div className='product'>
                    ...
                    <div className='product__info'>
                        ...
                        <div className='product__price'>
                            <div className='product__price_result'>{this.state.price * this.state.count}$</div>
                            <div className='product__price_count'>
                                <button className='product__price_number' onClick={this.minusCount}>-</button>
                                <div className='product__price_quantity'>{this.state.count}</div>
                                <button className='product__price_number' onClick={this.plusCount}>+</button>
                            </div>
                        </div>
                ...
                <div className='basket'>
                    <div className="basket__inner">
                        {this.props.basket.map(item => (
                            <div onClick={() => this.productInfo(item.name, item.img, item.description, item.price, item.composition, item.acute)} key={shortid.generate()} className='basket__item'>
                                <div className="basket__card">
                                    <div className="basket__card_title">{item.name}</div>
                                    <div className='basket__card_img' style={{background: `url('./img/${item.img}.jpg') no-repeat 50% / cover`}}>
