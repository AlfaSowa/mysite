...
var gridFilterItem = document.querySelectorAll('.grid__filter_item');
gridFilterItem.forEach(function (e) {
  e.addEventListener('click', function () {
    var gridFilterItemActive = document.querySelector('.grid__filter_item--active');
    gridFilterItemActive.classList.remove('grid__filter_item--active');
    e.classList.contains('grid__filter_item--active') !== true ? e.classList.add('grid__filter_item--active') : null;
  });
});
...
// EXTERNAL MODULE: ./static/js/header.js
var header = __webpack_require__(8);

// EXTERNAL MODULE: ./static/js/grid.js
...
// CONCATENATED MODULE: ./static/components/Last/Last.jsx
...
function (_Component) {
  ...
  function Last() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Last)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "createTabs", function () {
      var newTab = {
        id: Date.now()
      };
  ...
  _createClass(Last, [{
    ...
    value: function render() {
      ...
      }, react_default.a.createElement(Last_Tabs, {
        tabs: this.state.tabs
      }), react_default.a.createElement(Last_Pages, {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", {
        ...
        className: "fp__tabs_list"
      }, react_default.a.createElement("li", {
        className: "fp__tabs_item"
      }, this.state.firstTabName), this.state.country ? react_default.a.createElement("li", {
        className: "fp__tabs_item"
      }, this.state.lastTabName) : null));
    }
  }]);
...
function (_Last2) {
  ...
  function Pages() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(Pages)).call.apply(_getPrototypeOf3, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this2), "state", {
      page: []
    });

    _defineProperty(_assertThisInitialized(_this2), "createPage", function () {
      var newPage = {
        id: Date.now()
      };
    ...
    _defineProperty(_assertThisInitialized(_this2), "componentWillMount", function () {
      _this2.createPage();
    });
  ...
  _createClass(Pages, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        return react_default.a.createElement(Last_Page, {
          key: page.id,
...
function (_Pages) {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", {
        className: "fp__pages_list"
      }, this.props.page.map(function (elem) {
        return react_default.a.createElement("div", {
          key: elem.id,
          className: "page"
        }, react_default.a.createElement("div", {
          className: "page__title"
        }, "\u0437\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A \u044D\u043B\u0435\u043C\u0435\u043D\u0442\u0430 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u044B"));
      }));
    }
  }]);
...
// CONCATENATED MODULE: ./static/components/sidebar/Welcome.jsx
function Welcome_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Welcome_typeof = function _typeof(obj) { return typeof obj; }; } else { Welcome_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Welcome_typeof(obj); }
...
function (_Component) {
  ...
  function Welcome() {
    ...
    _this = Welcome_possibleConstructorReturn(this, (_getPrototypeOf2 = Welcome_getPrototypeOf(Welcome)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Welcome_defineProperty(Welcome_assertThisInitialized(_this), "state", {
      name: 'Alex',
      title: 'Заголовок',
  ...
  Welcome_createClass(Welcome, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", {
        ...
        className: "report__welcome"
      }, "Welcome, ".concat(this.state.name)), react_default.a.createElement("div", {
        className: "report"
      }, react_default.a.createElement("h3", {
        className: "report__title"
      }, this.state.title), react_default.a.createElement("div", {
        className: "report__txt"
      }, react_default.a.createElement("p", null, this.state.txt)), react_default.a.createElement("div", {
        className: "report__btn"
      }, react_default.a.createElement("a", {
        href: this.state.link
      }, "\u0447\u0438\u0442\u0430\u0442\u044C \u0434\u0430\u043B\u0435\u0435", react_default.a.createElement("svg", {
        className: "report__btn_arrow"
      }, react_default.a.createElement("use", {
        href: "#report__btn_arrow",
...
// CONCATENATED MODULE: ./static/components/sidebar/Reg.jsx
function Reg_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Reg_typeof = function _typeof(obj) { return typeof obj; }; } else { Reg_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Reg_typeof(obj); }

function Reg_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function Reg_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Reg_createClass(Constructor, protoProps, staticProps) { if (protoProps) Reg_defineProperties(Constructor.prototype, protoProps); if (staticProps) Reg_defineProperties(Constructor, staticProps); return Constructor; }

function Reg_possibleConstructorReturn(self, call) { if (call && (Reg_typeof(call) === "object" || typeof call === "function")) { return call; } return Reg_assertThisInitialized(self); }

function Reg_getPrototypeOf(o) { Reg_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Reg_getPrototypeOf(o); }

function Reg_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function Reg_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) Reg_setPrototypeOf(subClass, superClass); }

function Reg_setPrototypeOf(o, p) { Reg_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Reg_setPrototypeOf(o, p); }

function Reg_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function (_Component) {
  ...
  function Reg() {
    ...
    Reg_classCallCheck(this, Reg);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Reg_possibleConstructorReturn(this, (_getPrototypeOf2 = Reg_getPrototypeOf(Reg)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Reg_defineProperty(Reg_assertThisInitialized(_this), "state", {
      title: 'Заголовок',
    ...
    Reg_defineProperty(Reg_assertThisInitialized(_this), "handleChange", function (e) {
      _this.setState({
        text: e.target.value
      });
    });

    Reg_defineProperty(Reg_assertThisInitialized(_this), "handleSubmit", function (e) {
      e.preventDefault();
  ...
  Reg_createClass(Reg, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", {
        ...
        className: "reg__welcome"
      }, "Welcom"), react_default.a.createElement("div", {
        className: "reg"
      }, react_default.a.createElement("h3", {
        className: "reg__title"
      }, this.state.title), react_default.a.createElement("form", {
        onSubmit: this.handleSubmit
      }, react_default.a.createElement("label", null, react_default.a.createElement("div", {
        className: "reg__txt"
      }, this.state.txt), react_default.a.createElement("input", {
        onChange: this.handleChange,
        value: this.state.text
      })), react_default.a.createElement("button", null, "\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044F"))));
    }
  }]);
...
/*#__PURE__*/
function (_Component) {
  FrontPage_inherits(FrontPage, _Component);
  ...
  FrontPage_createClass(FrontPage, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        className: "fp"
      }, react_default.a.createElement(Last_Last, null));
    }
  }]);
...
react_dom_default.a.render(react_default.a.createElement(FrontPage_FrontPage, null), document.getElementById('root'));
