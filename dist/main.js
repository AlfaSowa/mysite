...
function (_React$Component) {
  ...
  function Item() {
    ...
    Item_defineProperty(Item_assertThisInitialized(_this), "getDetails", function (e, item) {
      e.preventDefault();
...
function (_React$Component2) {
  List_inherits(Details, _React$Component2);
  ...
  function Details() {
    ...
    _this3 = List_possibleConstructorReturn(this, (_getPrototypeOf3 = List_getPrototypeOf(Details)).call.apply(_getPrototypeOf3, [this].concat(args)));

    List_defineProperty(List_assertThisInitialized(_this3), "componentDidMount", function () {
      html.classList.add("details--active");
    });

    List_defineProperty(List_assertThisInitialized(_this3), "componentWillUnmount", function () {
  ...
  List_createClass(Details, [{
    ...
    value: function render() {
      ...
      }, detail.title), react_default.a.createElement("div", {
        onClick: close,
        className: "details__close"
      })), react_default.a.createElement("div", {
        className: "details__content"
      }, detail.content ? detail.content.map(function (item, index) {
        return react_default.a.createElement(List_DetailsTxt, {
          key: index,
          item: item
        });
      }) : null))));
...
function (_React$Component3) {
  List_inherits(DetailsTxt, _React$Component3);
  ...
  function DetailsTxt() {
    ...
    List_classCallCheck(this, DetailsTxt);

    for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      args[_key3] = arguments[_key3];
    }

    _this4 = List_possibleConstructorReturn(this, (_getPrototypeOf4 = List_getPrototypeOf(DetailsTxt)).call.apply(_getPrototypeOf4, [this].concat(args)));

    List_defineProperty(List_assertThisInitialized(_this4), "state", {
      showTxt: false
    });

    List_defineProperty(List_assertThisInitialized(_this4), "showTxt", function () {
      _this4.setState({
        showTxt: !_this4.state.showTxt
      });
    });
  ...
  List_createClass(DetailsTxt, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("div", {
        className: "details__item"
      }, react_default.a.createElement("span", {
        className: "details__item_toggler ".concat(this.props.item.txt ? 'details__item_dropdown' : ''),
        onClick: this.showTxt
      }, this.props.item.paragraph), this.props.item.txt ? react_default.a.createElement("p", {
        className: "details__item_txt ".concat(this.state.showTxt ? 'details__item_txt--active' : '')
      }, this.props.item.txt) : null);
    }
  }]);
...
function PageSpeed_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function PageSpeed_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function PageSpeed_createClass(Constructor, protoProps, staticProps) { if (protoProps) PageSpeed_defineProperties(Constructor.prototype, protoProps); if (staticProps) PageSpeed_defineProperties(Constructor, staticProps); return Constructor; }

function PageSpeed_possibleConstructorReturn(self, call) { if (call && (PageSpeed_typeof(call) === "object" || typeof call === "function")) { return call; } return PageSpeed_assertThisInitialized(self); }

function PageSpeed_getPrototypeOf(o) { PageSpeed_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return PageSpeed_getPrototypeOf(o); }

function PageSpeed_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function PageSpeed_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) PageSpeed_setPrototypeOf(subClass, superClass); }

function PageSpeed_setPrototypeOf(o, p) { PageSpeed_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return PageSpeed_setPrototypeOf(o, p); }

function PageSpeed_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }


var URL = 'https://alfa-sowa.me/';
var API_CALL = "https://www.googleapis.com/pagespeedonline/v5/runPagespeed?url=".concat(URL);

var PageSpeed_PageSpeed =
/*#__PURE__*/
function (_React$Component) {
  PageSpeed_inherits(PageSpeed, _React$Component);
  ...
  function PageSpeed() {
    ...
    PageSpeed_classCallCheck(this, PageSpeed);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = PageSpeed_possibleConstructorReturn(this, (_getPrototypeOf2 = PageSpeed_getPrototypeOf(PageSpeed)).call.apply(_getPrototypeOf2, [this].concat(args)));

    PageSpeed_defineProperty(PageSpeed_assertThisInitialized(_this), "state", {
      lightHouse: false,
      performance: null
    });

    PageSpeed_defineProperty(PageSpeed_assertThisInitialized(_this), "getPageSpeed",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    ...
    PageSpeed_defineProperty(PageSpeed_assertThisInitialized(_this), "componentDidMount", function () {
      _this.getPageSpeed();
    });
  ...
  PageSpeed_createClass(PageSpeed, [{
    key: "render",
    value: function render() {
      var _this$state = this.state,
          lightHouse = _this$state.lightHouse,
          performance = _this$state.performance;
      return lightHouse !== false ? react_default.a.createElement(LightHouse, {
...
function (_React$Component) {
  ...
  function App() {
    ...
    App_defineProperty(App_assertThisInitialized(_this), "state", {
      sectionRef: [],
      setSectionRef: function setSectionRef(e) {
        _this.state.sectionRef.push(e);
      }
    });

    App_defineProperty(App_assertThisInitialized(_this), "componentDidMount", function () {
      _this.state.sectionRef.forEach(function (elem) {
